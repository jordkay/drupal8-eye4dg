 ...
 * @endcode
 */
$settings['hash_salt'] = '08KsRL6pSamUMKJZ5RtTOzJRxKcJ_cvZ1SC4Y6wrvG9_kF981y8u7-NAxBMRGvvtCqFPtDTu4w';
...
if (file_exists('../settings')) {
  require('../settings/eye4dg_com-settings.inc');
}
$config_directories['sync'] = 'sites/eye4dg.com/config/sync';
$settings['install_profile'] = 'disced';
